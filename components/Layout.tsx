    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="sticky top-0 z-50 bg-[#F4ECD6]/80 backdrop-blur-md border-b border-[#310A31]/10">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link
            to="/"
            className="text-2xl font-serif font-bold tracking-tight text-[#310A31]"
          >
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link
              to="/"
              className={`relative transition-colors hover:text-opacity-70 ${
                isActive('#/') ? 'font-semibold active-link' : ''
              }`}
            >
              Home
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Your destination for hand-picked, premium products trending
                across social media. We curate only the best deals for your
                lifestyle.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mb-2">
                Email: businessguymr@gmail.com
              </p>
              <div className="bg-[#F4ECD6] p-4 rounded-xl mt-4 text-xs text-[#310A31]/80 italic">
                <strong>Affiliate Disclosure:</strong> As an affiliate partner,
                we may earn a small commission from qualifying purchases at no
                extra cost to you. This helps us keep this platform running.
              </div>
            </div>
          </div>
